...
type JasperToken struct {
	...
	Reporte           string           `json:"reporte" gorm:"not null;type:varchar(100);column:reporte"`
...
func (e *JasperToken) TableName() string {
	return "public.jasperToken"
}
