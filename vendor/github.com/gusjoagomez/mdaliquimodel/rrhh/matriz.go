...
type Matriz struct {
	...
	Descripcion       string           `json:"descripcion" gorm:"type:varchar(250);column:descripcion"`
	RetornaA          string           `json:"retornaA" gorm:"type:varchar(250);column:retornaA"`
	RetornaB          string           `json:"retornaB" gorm:"type:varchar(250);column:retornaB"`
...
func (e *Matriz) TableName() string {
	return "public.matriz"
}
