...
type TerminoAcumuladorConcepto struct {
	...
	TablaAuxiliarDetalle4      TablaAuxiliarDetalle       `gorm:"foreignKey:AgregacionId;references:Id"`
	...
	TerminoAcumuladorConcepto1 *TerminoAcumuladorConcepto `gorm:"foreignKey:BaseCalculoId;references:Id"`
...
func (e *TerminoAcumuladorConcepto) TableName() string {
	return "public.terminoAcumuladorConcepto"
}
