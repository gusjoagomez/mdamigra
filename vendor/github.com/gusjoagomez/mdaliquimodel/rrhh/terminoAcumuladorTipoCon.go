...
type TerminoAcumuladorTipoCon struct {
	...
	TipoConceptoId            uint                      `json:"tipoConceptoId" gorm:"type:int4;column:tipoConceptoId"`
	TablaAuxiliarDetalle1     TablaAuxiliarDetalle      `gorm:"foreignKey:TipoConceptoId;references:Id"`
	...
	TerminoAcumuladorTipoCon1 *TerminoAcumuladorTipoCon `gorm:"foreignKey:BaseCalculoId;references:Id"`
...
func (e *TerminoAcumuladorTipoCon) TableName() string {
	return "public.terminoAcumuladorTipoCon"
}
