...
type TerminoAtributo struct {
	...
	EntidadId             uint                 `json:"entidadId" gorm:"type:int4;column:entidadId"`
	TablaAuxiliarDetalle1 TablaAuxiliarDetalle `gorm:"foreignKey:EntidadId;references:Id"`
	AtributoId            uint                 `json:"atributoId" gorm:"type:int4;column:atributoId"`
	TablaAuxiliarDetalle2 TablaAuxiliarDetalle `gorm:"foreignKey:AtributoId;references:Id"`
...
func (e *TerminoAtributo) TableName() string {
	return "public.terminoAtributo"
}
