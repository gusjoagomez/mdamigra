...
type TerminoAuxiliar struct {
	...
	Campo             string           `json:"campo" gorm:"type:varchar(40);column:campo"`
...
func (e *TerminoAuxiliar) TableName() string {
	return "public.terminoAuxiliar"
}
