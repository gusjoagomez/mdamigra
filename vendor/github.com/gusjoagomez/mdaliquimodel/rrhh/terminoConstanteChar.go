...
type TerminoConstanteChar struct {
	...
	Valor             string           `json:"valor" gorm:"type:varchar(20);column:valor"`
...
func (e *TerminoConstanteChar) TableName() string {
	return "public.terminoConstanteChar"
}
