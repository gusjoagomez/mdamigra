...
type TerminoConstanteFloat struct {
	...
	Valor             decimal.Decimal  `json:"valor" gorm:"type:numeric(15,2);column:valor"`
...
func (e *TerminoConstanteFloat) TableName() string {
	return "public.terminoConstanteFloat"
}
