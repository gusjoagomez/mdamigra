...
type TerminoMatriz struct {
	...
	Retorna           string           `json:"retorna" gorm:"type:varchar(250);column:retorna"`
...
func (e *TerminoMatriz) TableName() string {
	return "public.terminoMatriz"
}
