...
type TerminoVariable struct {
	...
	Variable          string           `json:"variable" gorm:"type:varchar(20);column:variable"`
...
func (e *TerminoVariable) TableName() string {
	return "public.terminoVariable"
}
